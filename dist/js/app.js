...
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger); // == START Swiper script ==
...
document.querySelectorAll('.project_cards__wrapper').forEach(function (portfolioCardElement) {
  var portfolioCards = portfolioCardElement.querySelectorAll('.project_cards__wrapper > figure');
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(portfolioCards, {
    y: '100%',
    opacity: 0
  }, {
    scrollTrigger: {
...
document.querySelectorAll('.animatedBox').forEach(function (items) {
  var item = items.querySelectorAll('.project_cards__wrapper figure .box');
  var card = items.querySelectorAll('.project_cards__wrapper figure .card');
  var cardSubtitle = items.querySelectorAll('.project_cards__wrapper figure .card-content .subtitle');
  var cardContent = items.querySelectorAll('.project_cards__wrapper figure .card-content .content');
  var cardFooter = items.querySelectorAll('.project_cards__wrapper figure .card-footer');
  items.addEventListener('mouseenter', function (event) {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(cardSubtitle, {
      x: '100%',
      opacity: 0
    }, {
      x: 0,
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(cardContent, {
      // x: '100%',
      opacity: 0
    }, {
      // x: 0,
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(cardFooter, {
      // x: '100%',
      opacity: 0
    }, {
      // x: 0,
...
document.querySelectorAll('.project_resume__wrapper').forEach(function (projectThumbnails) {
  var projectThumbnail = projectThumbnails.querySelectorAll('.project_resume__card');
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(projectThumbnail, {
    x: '100%',
    opacity: 0
  }, {
    scrollTrigger: {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmmi"] = self["webpackChunkmmi"] || [];
